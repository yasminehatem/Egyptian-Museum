...
{
    public partial class NewKingdom : Form
    {
        ...
        private void NewKingdom_Load(object sender, EventArgs e)
        {
            this.WindowState = FormWindowState.Maximized;
            int PieceCount = controllerObj.CountPieces(5);
            int x = 0;
            int y = 0;
            for (int i = 1; i <= PieceCount; i++)
            {
                string ImagePath = controllerObj.GetPieceImage(5, i);
                ...
                label.Text = controllerObj.GetPieceTitle(5, i);
                label.AutoSize = true;
