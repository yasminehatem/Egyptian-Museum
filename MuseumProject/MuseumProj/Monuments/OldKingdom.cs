...
{
    public partial class OldKingdom : Form
    {
        ...
        private void OldKingdom_Load(object sender, EventArgs e)
        {
            this.WindowState = FormWindowState.Maximized;
            int PieceCount = controllerObj.CountPieces(3);
            int x = 0;
            int y = 0;
            for (int i = 1; i <= PieceCount; i++)
            {
                string ImagePath = controllerObj.GetPieceImage(3,i);
                ...
                label.Text = controllerObj.GetPieceTitle(3, i);
                label.AutoSize = true;
