...
{
    public partial class EarlyAges : Form
    {
        ...
        private void EarlyAges_Load(object sender, EventArgs e)
        {
            this.WindowState = FormWindowState.Maximized;
            int PieceCount = controllerObj.CountPieces(2);
            int x = 0;
            int y = 0;
            for (int i = 1; i <= PieceCount; i++)
            {
                string ImagePath = controllerObj.GetPieceImage(2, i);
                ...
                label.Text = controllerObj.GetPieceTitle(2, i);
                label.AutoSize = true;
