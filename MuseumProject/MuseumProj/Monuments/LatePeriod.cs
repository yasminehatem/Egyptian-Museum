...
{
    public partial class LatePeriod : Form
    {
        ...
        private void LatePeriod_Load(object sender, EventArgs e)
        {
            this.WindowState = FormWindowState.Maximized;
            int PieceCount = controllerObj.CountPieces(6);
            int x = 0;
            int y = 0;
            for (int i = 1; i <= PieceCount; i++)
            {
                string ImagePath = controllerObj.GetPieceImage(6, i);
                ...
                label.Text = controllerObj.GetPieceTitle(6, i);
                label.AutoSize = true;
